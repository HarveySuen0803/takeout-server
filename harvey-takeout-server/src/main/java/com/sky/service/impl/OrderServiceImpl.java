...
public class OrderServiceImpl implements OrderService {
    ...
    @Override
    public void insertOrderDetailList(Long orderId, List<ShoppingCart> shoppingCartList) {
    ...
    @Override
    public Order encapOrder(OrderSubmitDTO orderSubmitDTO, Long userId, AddressBook addressBook) {
        Order order = new Order();
    ...
    @Override
    public OrderSubmitVO encapOrderSubmitVO(Order order) {
